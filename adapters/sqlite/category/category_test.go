...
func (ts *TestSuite) TestCreate() {
	...
	ts.True(err.IsNil(), "Tentar criar uma categoria válida não deveria retornar erro")
}
...
func (ts *TestSuite) TestGetByUid_Exists() {
	...
	ts.True(err.IsNil(), "Tentar recuperar uma categoria informando um uid válido não deveria retornar erro")
...
func (ts *TestSuite) TestGetByUid_NotExists() {
	...
	ts.Equal(
		...
		repository.READ_CATEGORY_GET_BY_UID_ERROR.Other,
		"Tentar recuperar uma categoria informando um uid inválido deveria retornar " + repository.READ_CATEGORY_GET_BY_UID_ERROR.Other)
...
func (ts *TestSuite) TestUpdate() {
	...
	ts.True(err.IsNil(), "Tentar atualizar uma categoria com uid válido não deveria retornar erro")
...
func (ts *TestSuite) TestDelete() {
	...
	ts.True(err.IsNil(), "Tentar deletar uma categoria válida não deveria retornar erro")
	...
	ts.Equal(
		ltests.GetValueErrorMessage(err),
		repository.READ_CATEGORY_GET_BY_UID_ERROR.Other,
		"Tentar recuperar uma categoria previamente deletada deveria retornar " + repository.READ_CATEGORY_GET_BY_UID_ERROR.Other)
...
func (ts *TestSuite) TestHasSubcategories() {
	...
	ts.True(err.IsNil(), "HasSubcategories se informado um uid válido não deveria retornar erro")
...
func (ts *TestSuite) TestIsSubcategory() {
	...
	ts.True(err.IsNil(), "IsSubcategory, se informado duas chaves válidas não deveria retornar erro")
...
func (ts *TestSuite) TestIsAncestor() {
	...
	ts.True(err.IsNil(), "IsAncestor, se informado duas chaves válidas não deveria retornar erro")
...
func (ts *TestSuite) TestAreRelated() {
	...
	ts.True(err.IsNil(), "AreRelated, se informado duas chaves válidas não deveria retornar erro")
...
func (ts *TestSuite) TestInsertSubcategory() {
	...
	ts.True(err.IsNil(), "InsertSubcategory, se informado duas chaves válidas não deveria retornar erro")
...
func (ts *TestSuite) TestGetAllRootCategories_Empty() {
	...
	ts.True(err.IsNil(), "Tentar recuperar todas categorias raíz não deveria retornar erro")
...
func (ts *TestSuite) TestGetSubcategories_Empty() {
	...
	ts.True(err.IsNil(), "Tentar recuperar subcategorias de uma categoria válida não deveria retornar erro")
